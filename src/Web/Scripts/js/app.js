(function ($) {
    ...
    function model(data) {
        ...
        // json for properties markers on 
        $.each(data, function(i, prop) {
            ...
            p.area = prop.Area;
            p.lat = parseFloat(prop.Lat);
            p.lng = parseFloat(prop.Lng);
        ...
        var addMarkers = function(props, map) {
            $.each(props, function(i, prop) {
                ...
                var infoboxContent = '<div class="infoW">' +
                    '<div class="propImg">' +
                    '<img src="/images/imoveis/thumb/' + prop.image + '">' +
                    '<div class="propBg">' +
                    ...
                    '<a href="/Imoveis/Detalhes/'+prop.id+'" class="btn btn-sm btn-round btn-blue viewInfo">Ver</a>' +
                    '</div>' +
                    '</div>';
        ...
        setTimeout(function() {
            ...
            map.setCenter(new google.maps.LatLng(-23.550483, -46.633106));
            map.setZoom(11);
            ...
            if ($('#Address').length > 0) {
                ...
                google.maps.event.addListener(newMarker, "mouseup", function(event) {
                    $('#Lat').text(this.position.lat());
                    $('#Lng').text(this.position.lng());
                });
            }
        ...
        if ($('#Address').length > 0) {
            ...
            google.maps.event.addListener(addressAuto, 'place_changed', function() {
                ...
                var latitude = parseFloat(newMarker.getPosition().lat());
                var longitude = parseFloat(newMarker.getPosition().lng());
                $('#Lat').val(latitude);
                $('#Lng').val(longitude);
    ...
    window.applyBindings = function (formData) {

       imovel = new model(formData);
